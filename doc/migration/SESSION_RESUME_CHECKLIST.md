...
- `YYYY-MM-DD`: Session L klar - `AccountPlanRepository`, `VoucherRepository`, `AccountingYearRepository` interfaces + legacy adapters + V2-implementationer inkopplade i `Repositories`; integrationstester passerar.
