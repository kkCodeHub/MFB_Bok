...
- `2026-05-07`: Slice P steg 6 klar - `PeriodicInvoice` cutover genomförd: `Repositories.init(SSDB)` wire:ar nu alltid `V2PeriodicInvoiceRepository`, aktiva V1 `OBJECT`-paths för periodic invoices är avaktiverade i `SSDB`, död legacy-adapter `SSDBPeriodicInvoiceRepository` är borttagen, nytt guard-test `RepositoriesPeriodicInvoiceCutoverTest` tillagt, och `SSPeriodicInvoiceV2RepositoryTest` verifierar konkret V2-implementation; verifierat med `RepositoriesPeriodicInvoiceCutoverTest`, `SSPeriodicInvoiceV2IntegrationTest`, `SSPeriodicInvoiceV2RepositoryTest`, `RepositoriesHDomainCutoverTest`, `RepositoriesSupplierInvoiceCutoverTest`, `RepositoriesTenderCutoverTest`, `SSDBCustomerRepositoryTest`.
- `2026-05-07`: Slice P steg 7 klar - `CreditInvoice` cutover genomförd: `Repositories.init(SSDB)` wire:ar nu alltid `V2CreditInvoiceRepository`, aktiva V1 `OBJECT`-paths för credit invoices är avaktiverade i `SSDB`, död legacy-adapter `SSDBCreditInvoiceRepository` är borttagen, nytt guard-test `RepositoriesCreditInvoiceCutoverTest` tillagt, och `SSCreditInvoiceV2RepositoryTest` verifierar konkret V2-implementation; verifierat med `RepositoriesCreditInvoiceCutoverTest`, `SSCreditInvoiceV2IntegrationTest`, `SSCreditInvoiceV2RepositoryTest`, `RepositoriesHDomainCutoverTest`, `RepositoriesSupplierInvoiceCutoverTest`, `RepositoriesTenderCutoverTest`, `RepositoriesPeriodicInvoiceCutoverTest`, `SSDBCustomerRepositoryTest`.
- `2026-05-07`: Slice P steg 8 klar - `SupplierCreditInvoice` cutover genomförd: `Repositories.init(SSDB)` wire:ar nu alltid `V2SupplierCreditInvoiceRepository`, aktiva V1 `OBJECT`-paths för supplier-credit invoices är avaktiverade i `SSDB`, död legacy-adapter `SSDBSupplierCreditInvoiceRepository` är borttagen, nytt guard-test `RepositoriesSupplierCreditInvoiceCutoverTest` tillagt, och `SSSupplierCreditInvoiceV2RepositoryTest` verifierar konkret V2-implementation; verifierat med `RepositoriesSupplierCreditInvoiceCutoverTest`, `SSSupplierCreditInvoiceV2IntegrationTest`, `SSSupplierCreditInvoiceV2RepositoryTest`, `RepositoriesHDomainCutoverTest`, `RepositoriesSupplierInvoiceCutoverTest`, `RepositoriesTenderCutoverTest`, `RepositoriesPeriodicInvoiceCutoverTest`, `RepositoriesCreditInvoiceCutoverTest`, `SSDBCustomerRepositoryTest`.
- `2026-05-07`: Slice P steg 9 klar - `PurchaseOrder` cutover genomförd: `Repositories.init(SSDB)` wire:ar nu alltid `V2PurchaseOrderRepository`, aktiva V1 `OBJECT`-paths för purchase orders är avaktiverade i `SSDB`, död legacy-adapter `SSDBPurchaseOrderRepository` är borttagen, nytt guard-test `RepositoriesPurchaseOrderCutoverTest` tillagt, och `SSPurchaseOrderV2RepositoryTest` verifierar konkret V2-implementation; verifierat med `RepositoriesPurchaseOrderCutoverTest`, `SSPurchaseOrderV2IntegrationTest`, `SSPurchaseOrderV2RepositoryTest`, `RepositoriesHDomainCutoverTest`, `RepositoriesSupplierInvoiceCutoverTest`, `RepositoriesTenderCutoverTest`, `RepositoriesPeriodicInvoiceCutoverTest`, `RepositoriesCreditInvoiceCutoverTest`, `RepositoriesSupplierCreditInvoiceCutoverTest`, `SSDBCustomerRepositoryTest`.
- `2026-05-07`: Slice P steg 10 klar - `Order` cutover genomford: `Repositories.init(SSDB)` wire:ar nu alltid `V2OrderRepository`, aktiva V1 `OBJECT`-paths for order ar avaktiverade i `SSDB`, dod legacy-adapter `SSDBOrderRepository` ar borttagen, nytt guard-test `RepositoriesOrderCutoverTest` ar tillagt, och `SSOrderV2RepositoryTest` verifierar konkret V2-implementation; verifierat med `RepositoriesOrderCutoverTest`, `SSOrderV2IntegrationTest`, `SSOrderV2RepositoryTest`, `RepositoriesPurchaseOrderCutoverTest`, `RepositoriesHDomainCutoverTest`, `RepositoriesSupplierInvoiceCutoverTest`, `RepositoriesTenderCutoverTest`, `RepositoriesPeriodicInvoiceCutoverTest`, `RepositoriesCreditInvoiceCutoverTest`, `RepositoriesSupplierCreditInvoiceCutoverTest`, `SSDBCustomerRepositoryTest`.
- `2026-05-07`: Slice P steg 11 klar - `Indelivery` cutover genomford: `Repositories.init(SSDB)` wire:ar nu alltid `V2IndeliveryRepository`, aktiva V1 `OBJECT`-paths for indelivery ar avaktiverade i `SSDB`, dod legacy-adapter `SSDBIndeliveryRepository` ar borttagen, nytt guard-test `RepositoriesIndeliveryCutoverTest` ar tillagt, och `SSIndeliveryV2RepositoryTest` verifierar konkret V2-implementation; verifierat med `RepositoriesIndeliveryCutoverTest`, `SSIndeliveryV2IntegrationTest`, `SSIndeliveryV2RepositoryTest`, `RepositoriesOrderCutoverTest`, `RepositoriesPurchaseOrderCutoverTest`, `RepositoriesHDomainCutoverTest`, `RepositoriesSupplierInvoiceCutoverTest`, `RepositoriesTenderCutoverTest`, `RepositoriesPeriodicInvoiceCutoverTest`, `RepositoriesCreditInvoiceCutoverTest`, `RepositoriesSupplierCreditInvoiceCutoverTest`, `SSDBCustomerRepositoryTest`.
- `2026-05-07`: Slice P steg 12 klar - `Outdelivery` cutover genomford: `Repositories.init(SSDB)` wire:ar nu alltid `V2OutdeliveryRepository`, aktiva V1 `OBJECT`-paths for outdelivery ar avaktiverade i `SSDB`, dod legacy-adapter `SSDBOutdeliveryRepository` ar borttagen, nytt guard-test `RepositoriesOutdeliveryCutoverTest` ar tillagt, och `SSOutdeliveryV2RepositoryTest` verifierar konkret V2-implementation; verifierat med `RepositoriesOutdeliveryCutoverTest`, `SSOutdeliveryV2IntegrationTest`, `SSOutdeliveryV2RepositoryTest`, `RepositoriesIndeliveryCutoverTest`, `RepositoriesOrderCutoverTest`, `RepositoriesPurchaseOrderCutoverTest`, `RepositoriesHDomainCutoverTest`, `RepositoriesSupplierInvoiceCutoverTest`, `RepositoriesTenderCutoverTest`, `RepositoriesPeriodicInvoiceCutoverTest`, `RepositoriesCreditInvoiceCutoverTest`, `RepositoriesSupplierCreditInvoiceCutoverTest`, `SSDBCustomerRepositoryTest`.
- `2026-05-07`: Slice P steg 13 klar - `Inventory` cutover genomford: `Repositories.init(SSDB)` wire:ar nu alltid `V2InventoryRepository`, aktiva V1 `OBJECT`-paths for inventory ar avaktiverade i `SSDB`, dod legacy-adapter `SSDBInventoryRepository` ar borttagen, nytt guard-test `RepositoriesInventoryCutoverTest` ar tillagt, och `SSInventoryV2RepositoryTest` verifierar konkret V2-implementation; verifierat med `RepositoriesInventoryCutoverTest`, `SSInventoryV2IntegrationTest`, `SSInventoryV2RepositoryTest`, `RepositoriesOutdeliveryCutoverTest`, `RepositoriesIndeliveryCutoverTest`, `RepositoriesOrderCutoverTest`, `RepositoriesPurchaseOrderCutoverTest`, `RepositoriesHDomainCutoverTest`, `RepositoriesSupplierInvoiceCutoverTest`, `RepositoriesTenderCutoverTest`, `RepositoriesPeriodicInvoiceCutoverTest`, `RepositoriesCreditInvoiceCutoverTest`, `RepositoriesSupplierCreditInvoiceCutoverTest`, `SSDBCustomerRepositoryTest`.
- `2026-05-07`: Slice P steg 14 klar - `Outpayment` cutover genomford: `Repositories.init(SSDB)` wire:ar nu alltid `V2OutpaymentRepository`, aktiva V1 `OBJECT`-paths for outpayment ar avaktiverade i `SSDB`, dod legacy-adapter `SSDBOutpaymentRepository` ar borttagen, nytt guard-test `RepositoriesOutpaymentCutoverTest` ar tillagt, och `SSOutpaymentV2RepositoryTest` verifierar konkret V2-implementation; verifierat med `RepositoriesOutpaymentCutoverTest`, `SSOutpaymentV2IntegrationTest`, `SSOutpaymentV2RepositoryTest`, `RepositoriesInventoryCutoverTest`, `RepositoriesOutdeliveryCutoverTest`, `RepositoriesIndeliveryCutoverTest`, `RepositoriesOrderCutoverTest`, `RepositoriesPurchaseOrderCutoverTest`, `RepositoriesHDomainCutoverTest`, `RepositoriesSupplierInvoiceCutoverTest`, `RepositoriesTenderCutoverTest`, `RepositoriesPeriodicInvoiceCutoverTest`, `RepositoriesCreditInvoiceCutoverTest`, `RepositoriesSupplierCreditInvoiceCutoverTest`, `SSDBCustomerRepositoryTest`.
- `2026-05-07`: Slice P steg 15 klar - `Inpayment` cutover genomford: `Repositories.init(SSDB)` wire:ar nu alltid `V2InpaymentRepository`, aktiva V1 `OBJECT`-paths for inpayment ar avaktiverade i `SSDB`, dod legacy-adapter `SSDBInpaymentRepository` ar borttagen, nytt guard-test `RepositoriesInpaymentCutoverTest` ar tillagt, och `SSInpaymentV2RepositoryTest` verifierar konkret V2-implementation; verifierat med `RepositoriesInpaymentCutoverTest`, `SSInpaymentV2IntegrationTest`, `SSInpaymentV2RepositoryTest`, `RepositoriesOutpaymentCutoverTest`, `RepositoriesInventoryCutoverTest`, `RepositoriesOutdeliveryCutoverTest`, `RepositoriesIndeliveryCutoverTest`, `RepositoriesOrderCutoverTest`, `RepositoriesPurchaseOrderCutoverTest`, `RepositoriesHDomainCutoverTest`, `RepositoriesSupplierInvoiceCutoverTest`, `RepositoriesTenderCutoverTest`, `RepositoriesPeriodicInvoiceCutoverTest`, `RepositoriesCreditInvoiceCutoverTest`, `RepositoriesSupplierCreditInvoiceCutoverTest`, `SSDBCustomerRepositoryTest`.
- `2026-05-07`: Slice P steg 16 klar - `Invoice` cutover genomford: `Repositories.init(SSDB)` wire:ar nu alltid `V2InvoiceRepository`, aktiva V1 `OBJECT`-paths for invoice ar avaktiverade i `SSDB`, dod legacy-adapter `SSDBInvoiceRepository` ar borttagen, nytt guard-test `RepositoriesInvoiceCutoverTest` ar tillagt, och `SSInvoiceV2RepositoryTest` verifierar konkret V2-implementation; verifierat med `RepositoriesInvoiceCutoverTest`, `SSInvoiceV2IntegrationTest`, `SSInvoiceV2RepositoryTest`, `RepositoriesInpaymentCutoverTest`, `RepositoriesOutpaymentCutoverTest`, `RepositoriesInventoryCutoverTest`, `RepositoriesOutdeliveryCutoverTest`, `RepositoriesIndeliveryCutoverTest`, `RepositoriesOrderCutoverTest`, `RepositoriesPurchaseOrderCutoverTest`, `RepositoriesHDomainCutoverTest`, `RepositoriesSupplierInvoiceCutoverTest`, `RepositoriesTenderCutoverTest`, `RepositoriesPeriodicInvoiceCutoverTest`, `RepositoriesCreditInvoiceCutoverTest`, `RepositoriesSupplierCreditInvoiceCutoverTest`, `SSDBCustomerRepositoryTest`.
- `2026-05-29`: **Slice Q (SSNew* Domain Migration) kickstarted** — Punkt 4 Inventory domain initialization:
  1. Created `SLICE_Q_SSNEW_MIGRATION_PLAN.md` with comprehensive 5-point domain migration strategy.
  2. Enhanced repository interfaces with `createNew()` factory methods:
     - `InventoryRepository.createNew()` → returns auto-numbered SSInventory
     - `IndeliveryRepository.createNew()` → returns auto-numbered SSIndelivery
     - `OutdeliveryRepository.createNew()` → returns auto-numbered SSOutdelivery
  3. Implemented factory methods in V2Repository implementations (V2InventoryRepository, V2IndeliveryRepository, V2OutdeliveryRepository).
  4. Updated `SSInventoryDialog.newDialog()` to use `Repositories.inventories().createNew()` instead of `new SSInventory()` (first call-site migration).
  5. Repository tests pass: 9 tests (3x3 classes), 0 failures, verifying factory methods work correctly.
  6. Created `PUNKT_4_INVENTORY_PROGRESS.md` tracking detailed Punkt 4 execution status and next steps.
  7. Next: Update SSIndeliveryDialog and SSOutdeliveryDialog call sites; implement Phase 3-5 per SLICE_Q_SSNEW_MIGRATION_PLAN.md.
