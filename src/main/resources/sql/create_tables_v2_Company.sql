...
-- Active year-owned account set (child of tbl_accountingyear)
-- Invariant:
--   tbl_account acts as a global active workspace, not a historical archive.
--   At runtime it should contain account rows for exactly one open year at a time
--   (or be empty when no year is open).
CREATE TABLE IF NOT EXISTS tbl_account (
    id                   INTEGER IDENTITY,
    accountingyear_id    INTEGER       NOT NULL,
    ...
    CONSTRAINT uq_account_year_number UNIQUE (accountingyear_id, number)
);
...
CREATE TABLE IF NOT EXISTS tbl_company (
    ...
    smtp_port              INTEGER,
    smtp_bcc_addresses     VARCHAR(1000),
    smtp_auth              BOOLEAN       DEFAULT FALSE,
    smtp_connection_security VARCHAR(20),
    ...
    swish_image            VARCHAR(500),
    swish_text             VARCHAR(500),
    bank                   VARCHAR(255),
    ...
    CONSTRAINT fk_co_currency    FOREIGN KEY (currency_code)         REFERENCES PUBLIC.tbl_currency(code),
    CONSTRAINT fk_co_unit        FOREIGN KEY (standard_unit)         REFERENCES PUBLIC.tbl_unit(name),
    CONSTRAINT fk_co_payterm     FOREIGN KEY (default_payment_term)  REFERENCES PUBLIC.tbl_paymentterm(name),
    CONSTRAINT fk_co_delterm     FOREIGN KEY (default_delivery_term) REFERENCES PUBLIC.tbl_deliveryterm(name),
    CONSTRAINT fk_co_delway      FOREIGN KEY (default_delivery_way)  REFERENCES PUBLIC.tbl_deliveryway(name)
);
...
-- Per-company auto increment counters (Map<String, Integer> from SSAutoIncrement)
CREATE TABLE IF NOT EXISTS tbl_company_autoincrement (
    company_id         INTEGER       NOT NULL,
    counter_key        VARCHAR(64)   NOT NULL,
    next_number        INTEGER       NOT NULL,
    CONSTRAINT pk_co_auto_inc PRIMARY KEY (company_id, counter_key),
    CONSTRAINT fk_cai_company FOREIGN KEY (company_id) REFERENCES tbl_company(id)
);
...
-- Snapshot-based account plan storage (Release 1: Hybrid Light model)
CREATE TABLE IF NOT EXISTS tbl_accountingyear (
    ...
    -- Snapshot fields for year-specific account plan (Hybrid Light)
    accountplan        CLOB,
    accountplan_schema_version    INTEGER       DEFAULT 1,
    accountplan_compression_flag  VARCHAR(10)   DEFAULT 'gzip',
    accountplan_checksum          VARCHAR(64),
    accountplan_snapshot_version  INTEGER       DEFAULT 0,
    accountplan_updated_at        TIMESTAMP,
    accountplan_updated_by        VARCHAR(100),
    accountplan_name              VARCHAR(256),
    -- Active set marker for dirty-flag tracking (Hybrid Light)
    accountplan_dirty_flag        BOOLEAN       DEFAULT FALSE,
    CONSTRAINT pk_accountingyear PRIMARY KEY (id),
    CONSTRAINT fk_year_company   FOREIGN KEY (companyid)      REFERENCES tbl_company(id)
    -- accountplan_id is a soft reference only (no FK) in the snapshot model;
    -- the account plan is stored as a CLOB snapshot in the accountplan column.
);
...
CREATE TABLE IF NOT EXISTS tbl_product (
    ...
    only_whole_quantity  BOOLEAN       DEFAULT FALSE,
    unit                 VARCHAR(100),
    weight               DECIMAL(10,3),
    volume               DECIMAL(10,3),
    project_number       VARCHAR(50),
    ...
    CONSTRAINT fk_prod_unit    FOREIGN KEY (unit)      REFERENCES PUBLIC.tbl_unit(name)
);
...
-- Parcel/component rows for package products.
CREATE TABLE IF NOT EXISTS tbl_product_row (
    product_id          INTEGER       NOT NULL,
    ...
    CONSTRAINT fk_pr_product FOREIGN KEY (product_id) REFERENCES tbl_product(id)
        ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS tbl_customer (
    ...
    CONSTRAINT fk_cust_currency FOREIGN KEY (currency_code) REFERENCES PUBLIC.tbl_currency(code),
    CONSTRAINT fk_cust_payterm  FOREIGN KEY (payment_term)  REFERENCES PUBLIC.tbl_paymentterm(name),
    CONSTRAINT fk_cust_delterm  FOREIGN KEY (delivery_term) REFERENCES PUBLIC.tbl_deliveryterm(name),
    CONSTRAINT fk_cust_delway   FOREIGN KEY (delivery_way)  REFERENCES PUBLIC.tbl_deliveryway(name)
);
...
CREATE TABLE IF NOT EXISTS tbl_supplier (
    ...
    CONSTRAINT fk_supp_currency FOREIGN KEY (currency_code) REFERENCES PUBLIC.tbl_currency(code),
    CONSTRAINT fk_supp_payterm  FOREIGN KEY (payment_term)  REFERENCES PUBLIC.tbl_paymentterm(name),
    CONSTRAINT fk_supp_delterm  FOREIGN KEY (delivery_term) REFERENCES PUBLIC.tbl_deliveryterm(name),
    CONSTRAINT fk_supp_delway   FOREIGN KEY (delivery_way)  REFERENCES PUBLIC.tbl_deliveryway(name)
);
...
CREATE TABLE IF NOT EXISTS tbl_invoice (
    ...
    CONSTRAINT fk_inv_currency   FOREIGN KEY (currency_code) REFERENCES PUBLIC.tbl_currency(code),
    CONSTRAINT fk_inv_payterm    FOREIGN KEY (payment_term)  REFERENCES PUBLIC.tbl_paymentterm(name),
    CONSTRAINT fk_inv_delterm    FOREIGN KEY (delivery_term) REFERENCES PUBLIC.tbl_deliveryterm(name),
    CONSTRAINT fk_inv_delway     FOREIGN KEY (delivery_way)  REFERENCES PUBLIC.tbl_deliveryway(name)
);
...
CREATE TABLE IF NOT EXISTS tbl_creditinvoice (
    ...
    CONSTRAINT fk_cinv_currency     FOREIGN KEY (currency_code) REFERENCES PUBLIC.tbl_currency(code),
    CONSTRAINT fk_cinv_payterm      FOREIGN KEY (payment_term)  REFERENCES PUBLIC.tbl_paymentterm(name),
    CONSTRAINT fk_cinv_delterm      FOREIGN KEY (delivery_term) REFERENCES PUBLIC.tbl_deliveryterm(name),
    CONSTRAINT fk_cinv_delway       FOREIGN KEY (delivery_way)  REFERENCES PUBLIC.tbl_deliveryway(name)
);
...
CREATE TABLE IF NOT EXISTS tbl_periodicinvoice (
    ...
    CONSTRAINT fk_pinv_currency   FOREIGN KEY (currency_code)  REFERENCES PUBLIC.tbl_currency(code),
    CONSTRAINT fk_pinv_payterm    FOREIGN KEY (payment_term)   REFERENCES PUBLIC.tbl_paymentterm(name),
    CONSTRAINT fk_pinv_delterm    FOREIGN KEY (delivery_term)  REFERENCES PUBLIC.tbl_deliveryterm(name),
    CONSTRAINT fk_pinv_delway     FOREIGN KEY (delivery_way)   REFERENCES PUBLIC.tbl_deliveryway(name)
);
...
CREATE TABLE IF NOT EXISTS tbl_order (
    ...
    CONSTRAINT fk_ord_currency  FOREIGN KEY (currency_code) REFERENCES PUBLIC.tbl_currency(code),
    CONSTRAINT fk_ord_payterm   FOREIGN KEY (payment_term)  REFERENCES PUBLIC.tbl_paymentterm(name),
    CONSTRAINT fk_ord_delterm   FOREIGN KEY (delivery_term) REFERENCES PUBLIC.tbl_deliveryterm(name),
    CONSTRAINT fk_ord_delway    FOREIGN KEY (delivery_way)  REFERENCES PUBLIC.tbl_deliveryway(name)
);
...
CREATE TABLE IF NOT EXISTS tbl_tender (
    ...
    CONSTRAINT fk_tend_currency  FOREIGN KEY (currency_code) REFERENCES PUBLIC.tbl_currency(code),
    CONSTRAINT fk_tend_payterm   FOREIGN KEY (payment_term)  REFERENCES PUBLIC.tbl_paymentterm(name),
    CONSTRAINT fk_tend_delterm   FOREIGN KEY (delivery_term) REFERENCES PUBLIC.tbl_deliveryterm(name),
    CONSTRAINT fk_tend_delway    FOREIGN KEY (delivery_way)  REFERENCES PUBLIC.tbl_deliveryway(name)
);
...
CREATE TABLE IF NOT EXISTS tbl_supplierinvoice (
    ...
    CONSTRAINT fk_sinv_currency      FOREIGN KEY (currency_code)       REFERENCES PUBLIC.tbl_currency(code),
    CONSTRAINT fk_sinv_payterm       FOREIGN KEY (payment_term)        REFERENCES PUBLIC.tbl_paymentterm(name),
...
CREATE TABLE IF NOT EXISTS tbl_suppliercreditinvoice (
    ...
    CONSTRAINT fk_sci_currency            FOREIGN KEY (currency_code)          REFERENCES PUBLIC.tbl_currency(code),
    CONSTRAINT fk_sci_payterm             FOREIGN KEY (payment_term)           REFERENCES PUBLIC.tbl_paymentterm(name),
...
CREATE TABLE IF NOT EXISTS tbl_purchaseorder (
    ...
    CONSTRAINT fk_po_currency      FOREIGN KEY (currency_code) REFERENCES PUBLIC.tbl_currency(code),
    CONSTRAINT fk_po_payterm       FOREIGN KEY (payment_term)  REFERENCES PUBLIC.tbl_paymentterm(name),
    CONSTRAINT fk_po_delterm       FOREIGN KEY (delivery_term) REFERENCES PUBLIC.tbl_deliveryterm(name),
    CONSTRAINT fk_po_delway        FOREIGN KEY (delivery_way)  REFERENCES PUBLIC.tbl_deliveryway(name)
);
