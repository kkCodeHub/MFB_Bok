...
-- =============================================================================
-- CATEGORY I : Voucher series configuration (FAS 1: Multipla verifikatserier)
--              Java classes: V2VoucherEventType
-- =============================================================================

-- Global master data for fixed event codes (KF, FJ, IB, UB, etc.)
