...
class SSCompanyV2IntegrationTest {
    ...
    private static final String JDBC_URL = "jdbc:hsqldb:mem:fribok_test_v2_company";
    ...
    void addAndFetchCompanyWithFullV2ColumnsAndChildTables() {
        ...
        standardTexts.put(SSStandardText.Email, "Hej från V2-test");
        ...
        Optional<SSNewCompany> fetchedOpt = SSDB.getInstance().getCompany(company);
        ...
        assertThat(fetched.getStandardTexts()).containsEntry(SSStandardText.Email, "Hej från V2-test");
        ...
        SSDB.getInstance().deleteCompany(fetched);
    }
    ...
    void updateCompanyReplacesChildRowsInV2() {
        ...
        initialTexts.put(SSStandardText.Email, "Första text");
        ...
        updatedTexts.put(SSStandardText.Reminder, "Ny påminnelsetext");
        ...
        SSDB.getInstance().updateCompany(fetched);
        SSDB.getInstance().clearLists();

        Optional<SSNewCompany> updatedOpt = SSDB.getInstance().getCompany(fetched);
        assertThat(updatedOpt).isPresent();

        SSNewCompany updated = updatedOpt.get();
        assertThat(updated.getPhone()).isEqualTo("010-202020");
        assertThat(updated.getStandardTexts()).containsEntry(SSStandardText.Reminder, "Ny påminnelsetext");
        ...
        SSDB.getInstance().deleteCompany(updated);
    }
}
